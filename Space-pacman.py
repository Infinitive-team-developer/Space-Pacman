...
def process_commands(argv):
    """
    Processes the command line used to run Space-pacman. The command line can
    ...
    parser = argparse.ArgumentParser(
        ...
        description="Space-pacman Runner",
        epilog=textwrap.dedent(
            """
            USAGE:
                python Space-pacman.py <options>
                
            EXAMPLES:
                (1) python Space-pacman.py
                    - starts an interactive game
                (2) python pSpace-pacman.py --layout small_classic --zoom 2
